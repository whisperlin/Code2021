...
public class FtpHelper
{
    ...
    public void ChangeDir(string FtpRemotePath)
    {
        ftpRemotePath = FtpRemotePath;
    ...
    public void Delete(string fileName)
    {
        ...
        try
        {
            ...
            datastream.Close();
            response.Close();
            UnityEngine.Debug.Log("删除文件"+ fileName);
        }
        catch (Exception ex)
        {
    ...
    public void RemoveDirectory(string folderName)
    {
        ...
        {
            throw new Exception("FtpHelper Delete Error --> \n" + ex.ToString() + "\n  文件名:" + folderName);
        }
    }
    ...
    public string[] GetFilesDetailList()
    {
        ...
        {
            throw new Exception("FtpHelper  Error --> \n" + ex.ToString());
        }
    }
    ...
    public string[] GetFileList(string mask)
    {
        ...
        try
        {
            ...
            int _lastIndex = result.ToString().LastIndexOf('\n');
            if (_lastIndex > 0)
            {
                result.Remove(_lastIndex, 1);
            }
    ...
    public string[] GetDirectoryList()
    {
        ...
        foreach (string str in drectory)
        {
            ...
            else //if (str.Trim().Substring(0, 1).ToUpper() == "D")
            {
                ...
                {
                    /*判断 Unix 风格*/
                    string dir = str.Substring(index+3).Trim();
