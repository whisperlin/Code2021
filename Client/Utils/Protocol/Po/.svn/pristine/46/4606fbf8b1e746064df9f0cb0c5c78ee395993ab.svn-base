...
/// <summary>
 /// Echo测试包
 /// </summary>
public class EchoPo_Rp  : BasePo{

	public const int cmd = -1;
	public const string reflectClassName = "com.hbt.protocol.po.EchoPo_Rp";

	public EchoPo_Rp():base() {
		commandId = -1;
		encryptTypeDown = 0;
	}

	public EchoPo_Rp(MemoryStream inputStream){
		commandId = -1;
		encryptTypeDown = 0;
