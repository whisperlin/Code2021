...
/// <summary>
 /// 街区资料
 /// </summary>
public class AreaInfoPo_Rp  : BasePo{

	public const int cmd = -443218;
	public const string reflectClassName = "com.hbt.protocol.po.district.AreaInfoPo_Rp";

	public AreaInfoPo_Rp():base() {
		commandId = -443218;
		encryptTypeDown = 0;
	}

	public AreaInfoPo_Rp(MemoryStream inputStream){
		commandId = -443218;
		encryptTypeDown = 0;
