...
/// <summary>
 /// 卸下装备ID
 /// </summary>
public class EquipmentRemovePo_Rp  : BasePo{

	public const int cmd = -312150;
	public const string reflectClassName = "com.hbt.protocol.po.house.EquipmentRemovePo_Rp";

	public EquipmentRemovePo_Rp():base() {
		commandId = -312150;
		encryptTypeDown = 0;
	}

	public EquipmentRemovePo_Rp(MemoryStream inputStream){
		commandId = -312150;
		encryptTypeDown = 0;
